...
{{< figure src="resources/images/figure03.svg" caption="" alt="A tree diagram showing the category of humans subdivided into males, females, and 3rd-sex, with additional subdivisions by age."  >}}
...
{{< figure src="resources/images/figure04.svg" caption="" alt="A tree diagram showing the category of humans subdivided into infants, children, adolescents, and adults, with additional subdivisions by gender."  >}}
...
{{< figure src="resources/images/figure05.svg" caption="" alt="A diagram of a lattice showing interconnections between multiple nodes."  >}}
...
{{< figure src="resources/images/figure06.svg" caption="" alt="A diagram showing a lattice with all specific identity categories (e.g. humans, infants, males, children, etc.) and all of their possible combinations (e.g. infant females, intersex adults, etc.)."  >}}
...
{{< figure src="resources/images/figure07.svg" caption="" alt="A diagram showing a simplified lattice with only the specific feature combinations manifested in actual characters."  >}}
