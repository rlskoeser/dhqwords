...
{{< figure src="images/figure9.png" caption="Various parts of the new Tesserae website communicate with the API." alt="Image of a screenshot"  >}}
...
{{< figure src="images/figure12.png" caption="The button labeled SEARCH at the middle-left of the page sends the query to the /parallels/ endpoint. (In this image, the search button is greyed out because the query has already been sent.)" alt="Image of a screenshot"  >}}
