...
{{< figure src="resources/images/figure01.png" caption="Homepage" alt="A screenshot of the homepage"  >}}

  
{{< figure src="resources/images/figure02.png" caption="Quick start" alt="A screenshot of the Quick start page"  >}}

  
{{< figure src="resources/images/figure03.png" caption="Choosing a transformation" alt="A screenshot of the page example the transformation options"  >}}

  
{{< figure src="resources/images/figure04.png" caption="Downloading the resulting knowledge graph according to different serializations" alt="A screenshot of the download button producing different serializations of the knowledge graph"  >}}
